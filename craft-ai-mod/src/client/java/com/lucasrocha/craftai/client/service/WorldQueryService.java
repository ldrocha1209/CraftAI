...
/**
 * Runs bounded biome and structure lookups on the IntegratedServer thread and
 * caches reusable results briefly to keep repeated questions responsive.
 */
public final class WorldQueryService {
    ...
    private static CompletableFuture<WorldQueryResult> runOnServerThread(
        ...
        // Minecraft world data is not thread-safe; never run this supplier on
        // the client/render thread or a generic HTTP executor.
        server.execute(() -> {
