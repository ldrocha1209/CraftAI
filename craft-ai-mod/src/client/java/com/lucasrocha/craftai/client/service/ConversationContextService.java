...
/**
 * Keeps a short in-memory topic window. Independent questions, stale sessions,
 * world changes, and the fifth related follow-up all clear the previous topic.
 */
public final class ConversationContextService {
    ...
    public synchronized void recordSuccessfulTurn(
        ...
        if (relatedFollowUp) {
            ...
            // The fifth follow-up was answered with context; clear afterward so
            // an unrelated long conversation cannot grow into persistent memory.
