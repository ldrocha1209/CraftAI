...
public final class QueryIntentDetectorTest {
    ...
    private static final List<TestCase> CASES = List.of(
            ...
            general("Am I prepared to go to the Nether?", null),
            general("I want to find diamonds. What should I do?", null),
            general("How far is that?", null),
            general("What should I bring there?", null),
